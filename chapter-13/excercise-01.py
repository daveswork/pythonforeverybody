...
the country code is not there. Once you have it working, search for 
"Atlantic Ocean" and make sure it can handle locations that are not in any 
country.
"""
...
while True:
    ...
    try:
        country_code = js["results"][0]["address_components"][6]['short_name']
        print("Two letter country code:", country_code)
    except:
        print("No two letter country code found")
